...
hls_config_q['Flows'] = ['vivado_accelerator:fifo_depth_optimization']
hls4ml.model.optimizer.get_optimizer('vivado_accelerator:fifo_depth_optimization').configure(profiling_fifo_depth=100_000)
