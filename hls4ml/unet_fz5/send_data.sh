...
scp -P 8112 ./X_test.bin ./dma_driver.c petalinux@85.70.252.121:/home/petalinux/
...
#sudo dd if=/home/petalinux/X_test.bin of=/dev/mem bs=1 seek=$((0x00000000)) count=65536
#
...
# scp -P 8112 petalinux@85.70.252.121:/home/petalinux/Y_test.bin ./Y_test.bin
