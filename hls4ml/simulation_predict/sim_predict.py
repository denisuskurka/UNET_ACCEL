# File: hls4ml/simulation_predict/sim_predict.py
# Author: Denis Kurka
# Year: 2025
# License: CC0
...
def predict_imgs(mdl, output="predicted", output_folder="hls_output"):
    for i in range(1, 20):
        image_path = get_image_x_path("./data/images", i)
        ...
        pred.tofile("./"+output_folder+"/"+output+"_"+str(i)+".bin")
