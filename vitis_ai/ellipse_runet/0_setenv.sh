#!/bin/bash
# File: vitis_ai/ellipse_runet/0_setenv.sh
# Author: Denis Kurka
# Year: 2025
# License: CC0
...
export K_MODEL=ellipse_runet.h5
...
# target board
export BOARD=KV260
export ARCH=/workspace/FZ5-UNET/vitis_ai/ellipse_runet/arch.json
